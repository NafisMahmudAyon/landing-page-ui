...
export const CardContent: React.FC<CardContentProps> = ({ children, styles = "", variant = "1", ...rest }) => {
  ...
  return <div className={`${styles} ${variant ? variantValue.styles : ""
      }`} {...rest}>{children}</div>;
};
