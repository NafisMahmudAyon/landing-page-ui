  ...
  return (
    <>
      {iconEnable && (<>
        {label && <>
          {labelPosition === "before" && (
            <fieldset className={`${styles} relative h-fit group`} disabled={disabled}>
              ...
              <label htmlFor={label} className={`${labelStyles}`}>
                {label}{required ? <span className={`${required ? requiredStyles : ""}`}>{labelRequiredIcon}</span> : ""}
              </label>
          ...
          {labelPosition === "after" && (
            ...
            <fieldset className={`${styles} relative h-fit`} disabled={disabled}>
      ...
      {!iconEnable && (<>
        ...
        {label && <>
          {labelPosition === "before" && (
            <fieldset className={` ${styles} relative h-fit `}>
              <label htmlFor={label} className={`${labelStyles}`}>
                {label}{required ? <span className={`${required ? requiredStyles : ""}`}>{labelRequiredIcon}</span> : ""}
              </label>
              <input
                ...
                disabled={disabled}
                required={required}
                className={` ${inputStyles} ${disabled ? disabledStyles : ""}  border border-gray-400 w-full rounded-lg px-3 py-2 h-11 placeholder:font-normal placeholder:text-gray-400 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-gray-600 
              focus-visible:shadow-md text-gray-600 disabled:cursor-not-allowed disabled:opacity-50 bg-transparent ${iconEnable ? "ps-11" : ""} ${type === "password" ? "pe-11" : ""}  required:border-2 `}
                autoComplete={autoComplete}
                value={value}
                onChange={handleChange}
                {...rest}
          ...
          {labelPosition === "after" && <>
            <fieldset className={`${styles} relative h-fit`}>
              <input
                ...
                disabled={disabled}
                required={required}
                className={` ${inputStyles} ${disabled ? disabledStyles : ""} border border-gray-400 w-full rounded-lg px-3 py-2 h-11 placeholder:font-normal placeholder:text-gray-400 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-gray-600 focus-visible:shadow-md text-gray-600 disabled:cursor-not-allowed disabled:opacity-50 bg-transparent ps-11 pe-11 required:border-2 `}
                autoComplete={autoComplete}
                value={value}
                onChange={handleChange}
                {...rest}
