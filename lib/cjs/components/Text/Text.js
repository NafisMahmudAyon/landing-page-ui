...
export const Text = ({ styles = "", tagName, isLink, linkTo, id, target = "_self", children, variant, onClick, ...rest }) => {
    ...
    return (_jsx(CustomTag, { ...rest, onClick: onClick, id: id, className: ` ${styles} ${variantValue} `, ...(isLink && {
            href: linkTo,
            target: target,
        }), children: children }));
};
