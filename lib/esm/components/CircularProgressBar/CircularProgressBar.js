...
export const CircularProgressBar = ({ value, styles = "", onVisible, duration = 2, strokeColor = "#CCCCCC", strokeFillColor = "#333333", strokeWidth = 2, contentStyles = "", children, onClick, ...rest }) => {
